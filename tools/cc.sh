...
#
# The machine this port started on had w64devkit; the one it moved to has
# Visual Studio instead, so the build scripts ask this wrapper for a compiler
# rather than naming gcc.  Set CC to override.  Brought over from the sibling
# PC-98 port, where it is what actually builds on this machine.
#
