...
SIM="src/sim.c src/state.c src/world.c src/render.c src/orders.c src/ui.c src/dlg.c src/dlgdefs.c src/dlgrun.c src/toolbar.c src/panels.c src/endstage.c src/font.c src/font16.c src/bz.c src/gfx.c src/host.c src/zip.c"
