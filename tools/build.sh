...
SRC="src/win32_main.c src/world.c src/state.c src/sim.c src/render.c src/orders.c src/ui.c src/font.c src/font16.c src/bz.c src/gfx.c src/host.c src/zip.c"
