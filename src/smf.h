/* Taken from the sibling port windepth_wasm (github.com/yomei-o/windepth_wasm),
 * which faced the same problem: the original hands its .MID files to whatever
 * synthesiser Windows has, and a browser has none.  Both ports are the same
 * author's, and this file is unchanged apart from this note.
 */
